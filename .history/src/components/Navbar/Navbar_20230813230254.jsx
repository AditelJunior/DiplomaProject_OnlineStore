...
const Navigation = () => {
    ...
    const reduxSearchQuery = useSelector(state => state.shopping.searchQuery)
    ...
    <Navbar expand="lg" className="navbar">
        <div className="nav_container">
            ...
            <Form className="d-flex">
                ...
                />
                <Button variant="danger" type="submit" onSubmit={()=>searchSubmit()}>Поиск</Button>
            </Form>
        </div>
        ...
        <Navbar.Toggle className="navbar_toggler_button" aria-controls="navbarScroll" >
            <List/>
        </Navbar.Toggle>
            ...
            <Nav style={{ maxHeight: '500px' }}>
                ...
                CATEGORIES.map((category,i)=> {
                    return (
                        ...
                        :
                        <Link className="nav-item nav-link" to={category.link} key={i}>{category.title}</Link>
                    )
                })
                }
